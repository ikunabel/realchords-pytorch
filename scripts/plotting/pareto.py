    ...
    *,
    ...
    if missing:
        ...
        warnings.warn(
            ...
            + ", ".join(missing)
            + ". Re-run scripts/eval/evaluate_sequences/evaluate_generated_sequences.py for those systems.",
            stacklevel=1,
        )
...
def main(argv: Optional[List[str]] = None) -> None:
    ...
    parser.add_argument(
        ...
        help="Path to summary.json produced by scripts/eval/evaluate_sequences/evaluate_generated_sequences.py",
    )
    parser.add_argument(
        "--variant",
        action="append",
