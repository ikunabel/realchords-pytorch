...
Usage::
    ...
    python scripts/eval/custom_eval/embed_midi_clamp2.py
    python scripts/eval/custom_eval/embed_midi_clamp2.py --midi_dir path/to/midi --index 0
    python scripts/eval/custom_eval/embed_midi_clamp2.py --midi_path path/to/song.mid --output embedding.npy
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--midi_dir",
        type=str,
        default="logs/custom_eval/gt/hooktheory_all/full_songs/midi",
