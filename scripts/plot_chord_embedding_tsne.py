...
2. Summary-derived groups: provide `--summary SUMMARY_JSON` together with one or
   ...
   `scripts/eval/evaluate_sequences/evaluate_generated_sequences.py`.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Summary JSON produced by scripts/eval/evaluate_sequences/evaluate_generated_sequences.py.",
    )
    parser.add_argument(
        "--group_from_summary",
        action="append",
