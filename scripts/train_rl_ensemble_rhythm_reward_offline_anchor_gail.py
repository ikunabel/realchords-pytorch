...
def main(args, save_dir: str = ""):
    ...
    gail_reward_model = DiscriminativeReward(
        ...
        max_seq_len=model.max_seq_len // 2 + 1,  # + 1 for bos
    ...
    # Need to create the reward function after wrapping model in deepspeed engine
        ...
        reward_configs.append(
            {
                ...
                "clip_range": getattr(
                    args, f"contrastive_reward_clip_range", None
                ),
            }
        )
        ...
        reward_configs.append(
            {
                ...
                "clip_range": getattr(
                    args, f"discriminative_reward_clip_range", None
                ),
            }
        )
        ...
        reward_configs.append(
            {
                ...
                "clip_range": getattr(
                    args, f"contrastive_reward_rhythm_clip_range", None
                ),
            }
        )
        ...
        reward_configs.append(
            {
                ...
                "clip_range": getattr(
                    args, f"discriminative_reward_rhythm_clip_range", None
                ),
            }
        )
    ...
    reward_configs.append(
        {
            ...
            "name": "gail_reward",
            "clip_range": getattr(args, f"gail_reward_clip_range", None),
        }
    )
