...
#
# Slurm:
#   EVAL_GROUP=gapt_multiscale_batch sbatch jobscripts/submit_evaluate_sequences.sh
#   EVAL_SYSTEMS='hooktheory_gt wikifonia_gt' sbatch jobscripts/submit_evaluate_sequences.sh
