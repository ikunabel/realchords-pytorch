...
NaiveReplayBuffer and related classes for PPO training.
"""
...
class NaiveReplayBuffer(ABC):
    ...
    def normalize(self, attribute: str, strategy) -> None:
        ...
        # for DP
        # mean
        masked_sum = (items_vector * action_masks_vector).sum()
        sum_and_count = torch.tensor([masked_sum, num_actions], device=items_vector.device)
