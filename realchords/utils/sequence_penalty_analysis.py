...
This module is the reusable core behind `scripts/eval/evaluate_sequences/analyze_sequence_penalties.py` and
the combined `scripts/eval/evaluate_sequences/evaluate_generated_sequences.py` entry point. Keeping these
